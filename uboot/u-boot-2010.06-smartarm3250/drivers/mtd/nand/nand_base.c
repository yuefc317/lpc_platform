			  ...
			  size_t *retlen, const uint8_t *buf)
{
	...
	//	printf("len= %d, datasize=%d, oobsize=%d,old pages=%d\n", len, datasize, oobsize, datapages);
	//	datapages = len/(datasize+oobsize);
	//	printf("***************new pages = %d\n", datapages);
	...
	if(mtd->rw_oob != 1){
		...
		//chip->ops.ooblen = (mtd->oobsize)*(len/(mtd->writesize));
